...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<Object> handleWorkflowExecutionException(WorkflowFailedException ex) {
    ErrorDto err = new ErrorDto();
    HttpStatus httpStatus = HttpStatus.INTERNAL_SERVER_ERROR;
    if (ex.getCause() instanceof ApplicationFailure af
        && HttpStatus.NOT_FOUND.getReasonPhrase().equals(af.getOriginalMessage())) {
      httpStatus = HttpStatus.NOT_FOUND;
      err.setMessage(af.getMessage());
      err.code(String.valueOf(httpStatus.value()));
      err.title(HttpStatus.NOT_FOUND.getReasonPhrase());
    }
